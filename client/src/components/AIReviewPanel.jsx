        ...
        >
          ...
          >
            ...
            <div className="overflow-y-auto max-h-[65vh] prose prose-sm md:prose-base text-gray-800 custom-scroll">
              {loading ? (
                <div className="flex flex-col items-center justify-center h-32 text-base text-gray-600 animate-pulse">
                  <svg className="animate-spin h-7 w-7 mb-2 text-primary-400" viewBox="0 0 24 24">
